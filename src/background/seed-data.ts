...
const SEED_SETS: Record<0 | 1 | 2, SeedSet> = {
    ...
    2: {
        ...
        requests: [
            ...
            { w2gId: 'User-TEST4', title: 'Stupid Girl - by Garbage', url: 'https://www.youtube.com/watch?v=GnBbB7Eft9A' },
            { w2gId: 'User-TEST5', title: 'Fever - by The Black Keys', url: 'https://www.youtube.com/watch?v=GwVBVpPAW-c' },
            { w2gId: 'User-TEST0', title: 'Mad World - by Gary Jules', url: 'https://www.youtube.com/watch?v=H-lum6BBF3g' },
            { w2gId: 'User-TEST1', title: 'You\'ll Never Find - by Lou Rawls', url: 'https://www.youtube.com/watch?v=hB2a13mE2hY' },
            { w2gId: 'User-TEST2', title: 'Only Happy When It Rains - by Garbage', url: 'https://www.youtube.com/watch?v=hv989pjwCC0' },
            { w2gId: 'User-TEST3', title: 'Are You Gonna Go My Way - by Lenny Kravitz', url: 'https://www.youtube.com/watch?v=iecV-eHfLNs' },
            { w2gId: 'User-TEST4', title: 'Color My World - by Chicago', url: 'https://www.youtube.com/watch?v=iJgyuvTayjg' },
            { w2gId: 'User-TEST5', title: 'Boom Boom Ba', url: 'https://www.youtube.com/watch?v=j9YyjJxKWnI' },
            { w2gId: 'User-TEST0', title: 'Bad Day - by Daniel Powter', url: 'https://www.youtube.com/watch?v=JCp84_B2Nd8' },
            { w2gId: 'User-TEST1', title: 'Simply Irresistable - by Robert Palmer', url: 'https://www.youtube.com/watch?v=jM6Y2g_nODM' },
            { w2gId: 'User-TEST2', title: 'Jenny - by Tommy Tutone', url: 'https://www.youtube.com/watch?v=joJgqYOziYw' },
            { w2gId: 'User-TEST3', title: 'Minute By Minute - by Doobie Brothers', url: 'https://www.youtube.com/watch?v=jrPC4luIZbU' },
            { w2gId: 'User-TEST4', title: 'When You Say Nothing At All - by Keith Whitley', url: 'https://www.youtube.com/watch?v=k2ALC3yFSdE' },
            { w2gId: 'User-TEST5', title: 'Closer - by The Chainsmokers', url: 'https://www.youtube.com/watch?v=kaMm0JvFWhM' },
            { w2gId: 'User-TEST0', title: 'Godzilla - by Blue Oyster Cult', url: 'https://www.youtube.com/watch?v=kDO648hBwZE' },
            { w2gId: 'User-TEST1', title: 'The Diary of Horace Wimp - by E.L.O.', url: 'https://www.youtube.com/watch?v=kgHgInZw190' },
            { w2gId: 'User-TEST2', title: 'I Like You Better Than Me - by Bebe Rexha', url: 'https://www.youtube.com/watch?v=l8_MOltmUKM' },
            { w2gId: 'User-TEST3', title: 'Low - by T. Pain', url: 'https://www.youtube.com/watch?v=LhDVZVNiQlM' },
            { w2gId: 'User-TEST4', title: 'Uprising - by Muse', url: 'https://www.youtube.com/watch?v=lhsjiyGnsxY' },
            { w2gId: 'User-TEST5', title: 'Next Summer - by Damiano David', url: 'https://www.youtube.com/watch?v=LR8R-etDTj0' },
        ]
    }
};
